...
<template>
  <div class="back"> <div class="back2"><el-button @click="goBack"> &lt;- Назад</el-button></div></div>
    ...
    <div v-if="data && !data.error" class="data2">
      <div  class="containerMain">
        <div class="left">
          ...
          <el-icon v-if="isFavorite === false" @click="chechFavorite"><StarFilled /></el-icon>
          <el-icon v-if="isFavorite"><CircleCheckFilled /></el-icon>
        </div>
        <div class="right">
          <div class="about">
      ...
      <el-divider v-if="!data.error "  class="divid"/>
